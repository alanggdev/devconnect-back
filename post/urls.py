...
from .views import get_all_posts, create_post, get_detail_post, update_post, get_user_posts, delete_post, get_following_posts
...
urlpatterns = [
    ...
    path('following', get_following_posts, name='follow-post'),
]